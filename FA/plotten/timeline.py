...
LIMIT 50;
"""
# Führen Sie die Abfrage aus und lesen Sie das Ergebnis in einen DataFrame
...
# Für jeden Status-Eintrag plotten
...
#start/start event/stop/stop event hinzufügen 
...
# Benutzerdefinierten Locator setzen
plt.gca().xaxis.set_major_locator(FixedLocator(unique_timestamps))

# Format für Datum und Uhrzeit setzen
