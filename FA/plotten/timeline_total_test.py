...
von = '2023-06-19 00:00:00.000000'  
bis = '2023-06-22 00:00:00.000000'
...
sql_query = """
SELECT cmv.connector_pk, cmv.value_timestamp, cmv.value, cmv.measurand, cmv.phase, cmv.unit, ts.transaction_pk, cs.status_timestamp, cs.status 
