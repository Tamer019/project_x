        ...
        try:
            ...
            if difference_minutes > 30:
                ...
                all_results.append({
                    ...
                    'Hersteller': group['Hersteller'].iloc[0],
...
# Gesamtanzahl der Verstöße für jeden Nachnamen berechnen
if not results_df.empty:
    verstoesse_pro_nachname = results_df['Nachname'].value_counts()
    results_df['Anzahl Verstöße'] = results_df['Nachname'].map(verstoesse_pro_nachname)
...
for row in sheet.iter_rows():
    ...
    sheet.protection.sheet = True   # Diese Zeile aktiviert den Schutz für das Arbeitsblatt
    sheet.protection.password = 'IFS123'  # Passwort setzen
    workbook.security = WorkbookProtection(workbookPassword='IFS123', lockStructure=True, lockWindows=True)
